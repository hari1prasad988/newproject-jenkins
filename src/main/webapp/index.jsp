...
<head>
  ...
  <title>Maison — Curated Modern Living</title>
  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .search i { color: var(--mist); font-size: 0.9rem; }
    .search input {
      flex: 1;
      border: none;
      outline: none;
    ...
    .search .search-go:hover { background: var(--terracotta); transform: rotate(-8deg); }
    ...
    .cat-card::before {
      ...
      position: absolute;
      inset: 0;
      background: linear-gradient(180deg, transparent 40%, color-mix(in srgb, var(--terracotta) 8%, transparent) 100%);
      opacity: 0;
